...
function Register() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 relative flex items-center justify-center p-4 sm:p-6 overflow-hidden">
            ...
            {/* Main Register Card */}
            <div className="w-full max-w-lg bg-white/90 backdrop-blur-md rounded-2xl shadow-xl shadow-teal-900/5 border border-slate-200/80 p-6 sm:p-8 relative z-10">
